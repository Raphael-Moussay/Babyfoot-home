  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative z-10 card p-10 w-full max-w-sm text-center animate-pop">
        ...
        <h1 className="font-display text-4xl gradient-text mb-2">BABY-FOOT</h1>
        <p className="text-gray-500 text-sm mb-8">Connectez-vous pour enregistrer vos victoires</p>

        <button
          onClick={handleGoogleLogin}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 
                     font-semibold py-3 px-5 rounded-xl hover:bg-gray-100 transition-all 
        ...
        <p className="text-gray-600 text-xs mt-6">
          Seuls les joueurs inscrits peuvent enregistrer des matchs.
        </p>
      </div>
    </div>
  )
